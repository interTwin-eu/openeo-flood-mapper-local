---
title: "Flood mapping with openEO (local)"
subtitle: "interTwin"
execute:
  keep-ipynb: true
author: 
...
from openeo.processes import ProcessBuilder, array_element, add, multiply, sin, cos, exp
```
...
flood_dc = flood_dc.mask(mask_ia)
```
...
flood_dc = flood_dc.mask(mask_conflict)
```
...
flood_dc = flood_dc.mask(mask_land_outliers & mask_water_outliers)
```
...
flood_dc = flood_dc.mask(mask_uncertainty)
```
